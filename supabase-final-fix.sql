-- FINAL FIX: Complete Supabase Setup for Rork History Scanner App
...
-- =====================================================
-- 2. ENSURE SCAN_HISTORY TABLE EXISTS WITH CORRECT SCHEMA
-- =====================================================
...
-- =====================================================
-- 3. ENSURE CHAT_SESSIONS TABLE EXISTS
-- =====================================================
...
-- Function to update the last_updated timestamp for chat_sessions
...
AND table_name IN ('profiles', 'scan_history', 'chat_sessions')
ORDER BY table_name;

-- Check columns in scan_history table
SELECT 
    'scan_history columns:' as status,
    column_name,
    data_type,
    is_nullable
...
SELECT 
    'chat_sessions columns:' as status,
    column_name,
    data_type,
    is_nullable
FROM information_schema.columns 
...
AND tablename IN ('profiles', 'scan_history', 'chat_sessions')
...
AND event_object_table IN ('profiles', 'scan_history', 'chat_sessions')
ORDER BY event_object_table, trigger_name;

-- Final success message
SELECT 'SUCCESS: All tables, policies, triggers, and indexes have been created successfully!' as final_status;