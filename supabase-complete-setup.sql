-- Complete Supabase Setup for Rork History Scanner App
...
-- Insert sample scan history (only if you want test data)
...
INSERT INTO public.scan_history (
    ...
    'Rome, Italy',
    'Ancient Roman',
    'The Colosseum is an ancient amphitheater built in the 1st century AD.',
    'It is one of the most iconic symbols of Imperial Rome.',
    ARRAY['Could hold up to 80,000 spectators', 'Used for gladiatorial contests', 'Built in 70-80 AD'],
    95,
    true
);
*/
...
-- =====================================================
-- 6. CHAT SESSIONS TABLE (for AI chat functionality)
-- =====================================================
...
AND event_object_table IN ('profiles', 'scan_history', 'chat_sessions', 'users');
