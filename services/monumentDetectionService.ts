...
async function performComprehensiveAnalysis(base64Image: string, additionalInfo?: AdditionalInfo): Promise<DetectionResult> {
  ...
  analysisPrompt += `\n\nProvide ALL information in ONE response. Only mark isRecognized as true if confidence is 80+. Always provide the ACTUAL location, not user's location unless they match.\n\nRespond in this JSON format:\n{\n"artworkName": "Name or 'Unknown Artwork'",\n"confidence": 85,\n"location": "Actual location",\n"period": "Period/artist or 'Unknown'",\n"isRecognized": true/false,\n"detailedDescription": {\n  "keyTakeaways": "Summary of most important pieces of information from (~500 chars)",\n  "inDepthContext": "Interesting, specific content (1200-3000 chars) structured in 2-3 logical paragraphs with **bold** highlights.  Organize in 3 paragraphs just by spacing them and do not add titles. Be intersting and creative depending on the pice of art bu here's an example: PARAGRAPH 1: Historical origins, creation context, artist/architect background, and period significance. PARAGRAPH 2: Artistic/architectural details, materials, techniques, style characteristics, and unique features. PARAGRAPH 3: Cultural impact, restoration history, current significance, and notable recognition. Be specific adding names, anecdotes and technical details. Avoid generalizations.",\n  "curiosities": "Interesting anecdotes, lesser-known facts, or unusual stories or 'No widely known curiosities are associated with this artwork.'",\n  "keyTakeawaysList": ["Summary of in-depth context main 4 points"]\n}\n}\n\nIf not recognized with high confidence, omit detailedDescription.`;
